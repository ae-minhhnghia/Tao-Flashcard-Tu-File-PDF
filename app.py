...
# Cấu hình SQL Server
SQL_SERVER_CONFIG = {
    'server': 'your-sql-server-host',  # Thêm cổng nếu cần
    'database': 'flashcardGeneratorDB',
    'username': 'your-username',
    'password': 'password',
    'driver': 'ODBC Driver 17 for SQL Server'  # Thêm driver vào cấu hình
}
...
def connect_to_db():
    try:
        ...
        connection_string = (
            ...
            "Encrypt=no;"  # Tắt mã hóa nếu dùng localhost hoặc không có certificate
            "TrustServerCertificate=yes;"  # Chấp nhận self-signed certificate
            "Connection Timeout=30;"  # Tăng thời gian timeout
        )
